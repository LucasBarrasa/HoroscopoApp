...
class HoroscopoAdapter(private var signo: List<HoroscopeInfo> = emptyList(), private val onSignoSelected:(HoroscopeInfo)->Unit) :
    ...
    override fun onBindViewHolder(viewHolder: HoroscopoViewHolder, position: Int) {
        viewHolder.render(signo[position], onSignoSelected)
    }
